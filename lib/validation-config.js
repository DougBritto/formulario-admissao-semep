...
const FIELD_MESSAGES = {
  ...
  invalidDependentDnvRequired: 'DNV do dependente é obrigatório para nascidos a partir de fevereiro de 2010.',
  invalidDependentCpf: 'CPF do dependente inválido.',
  invalidRgIssuerWithUf: 'Órgão emissor do RG deve ser informado no formato ÓRGÃO/UF, por exemplo: SSP/MG.',
...
function buildClientValidationConfig() {
  return {
    ...
    fieldMessages: {
      ...
      invalidDependentDnvRequired: FIELD_MESSAGES.invalidDependentDnvRequired,
      invalidDependentCpf: FIELD_MESSAGES.invalidDependentCpf,
      invalidRgIssuerWithUf: FIELD_MESSAGES.invalidRgIssuerWithUf
    }
  };
}
